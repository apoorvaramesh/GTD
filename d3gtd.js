...
var D3gtd = function () {
	function D3gtd(options) {
		...
		Promise.all([d3.json('https://bitbucket.org/apoorva_r/dv/raw/06fb2ab2eb80681df5119233981bab51f1a4848d/inputFiles/world.json'), d3.json('https://bitbucket.org/apoorva_r/dv/raw/06fb2ab2eb80681df5119233981bab51f1a4848d/inputFiles/countryCodeMapping.json'), d3.csv('https://bitbucket.org/apoorva_r/dv/raw/06fb2ab2eb80681df5119233981bab51f1a4848d/inputFiles/gtdata_filter.csv')]).then(function (_ref) {
...
var D3gtd_visblock = exports.D3gtd_visblock = function () {
  function D3gtd_visblock(options) {
    ...
    this.barchart.append('text').text('Date').attr('y', '297').attr('x', this.container.node().getBoundingClientRect().width - 25).attr('font-size', '10px').attr('font-weight', '700').attr('text-anchor', 'middle');
    ...
    this.linechart.append('text').text('Date').attr('y', '297').attr('x', this.container.node().getBoundingClientRect().width - 25).attr('font-size', '10px').attr('font-weight', '700').attr('text-anchor', 'middle');
    this.linechart.append('text').text('Number of incidents per year').attr('y', '22').attr('x', this.container.node().getBoundingClientRect().width / 2).attr('font-size', '14px').attr('font-weight', '700').attr('text-anchor', 'middle');
